...
class CarState(CarStateBase, EsccCarStateBase, MadsCarState):
  ...
  def update_canfd(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.enableBsm:
      left_blindspot, right_blindspot = "FL_INDICATOR", "FR_INDICATOR"
      if self.CP.carFingerprint == CAR.HYUNDAI_IONIQ_5_N:
        left_blindspot, right_blindspot = "FL_INDICATOR_ALT", "FR_INDICATOR_ALT"
      ret.leftBlindspot = cp.vl["BLINDSPOTS_REAR_CORNERS"][left_blindspot] != 0
      ret.rightBlindspot = cp.vl["BLINDSPOTS_REAR_CORNERS"][right_blindspot] != 0
