...
class CAR(Platforms):
  ...
  HYUNDAI_IONIQ_5_N = HyundaiCanFDPlatformConfig(
    [HyundaiCarDocs("Hyundai Ioniq 5 N (with HDA II) 2023-24", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_s]))],
    CarSpecs(mass=2230, wheelbase=3.00, steerRatio=12.54, tireStiffnessFactor=1.3),
    flags=HyundaiFlags.EV | HyundaiFlags.CANFD_NO_RADAR_DISABLE,
  )
